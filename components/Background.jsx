  ...
  return (
    <section className="section background" id="background">
      <div className="content">
        ...
        <div className="items">
          <div className="item">
            <h3 className="company">Andrii Litkovskyi Marketing</h3>
            <h2 className="role">Digital Marketing Consultant</h2>
            <p className="metadata">
              <span className="location">hille · germany</span>
              <span className="time">september 2022 — present</span>
            </p>
          ...
          <div className="item">
            <h3 className="company">Stimul Sport Resort</h3>
            <h2 className="role">Digital Marketing & Performance Manager</h2>
            <p className="metadata">
              <span className="location">feodosiya · ukraine</span>
              <span className="time">january 2015 — september 2022</span>
            </p>
            <p className="description">
          ...
          <div className="item">
            <h3 className="company">Sunny Bay Hotel</h3>
            <h2 className="role">Paid Social & SEO Manager</h2>
            <p className="metadata">
              <span className="location">feodosiya · ukraine</span>
              <span className="time">mai 2009 — january 2015</span>
            </p>
            <p className="description">
