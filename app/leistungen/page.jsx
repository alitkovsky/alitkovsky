...
export const metadata = {
  ...
  description: "SEO, Google Ads, Paid Social, Web Analytics und CRM-Automatisierung für lokale Unternehmen in OWL. Praxen, Handwerker, Dienstleister — mehr Kunden durch digitales Marketing.",
