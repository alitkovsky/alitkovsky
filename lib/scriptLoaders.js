...
const CLARITY_ID = process.env.NEXT_PUBLIC_CLARITY_ID || "u5e9f1dftb";
 ...
 * GTM is loaded in layout.jsx, we update consent via Google Consent Mode v2
 */
